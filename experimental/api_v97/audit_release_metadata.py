...
v12_rc1_release_notes_path = root / 'RELEASE_NOTES_v1.2.0-rc2.md'
...
if candidate_mode:
    ...
    notes.append(
        'Root package is the v1.2.0rc2 candidate; published CITATION.cff and Zenodo metadata intentionally remain on v1.1.0 until explicit RC publication.'
    )
else:
