...
candidate_version = '1.2.0rc2'
candidate_tag_version = '1.2.0-rc2'
...
# Published metadata must remain pinned to v1.1.0 while v1.2.0rc2 is only a candidate.
...
if candidate_mode:
    rc_path = root / 'RELEASE_NOTES_v1.2.0-rc2.md'
    if not rc_path.exists():
        errors.append('RELEASE_NOTES_v1.2.0-rc2.md is missing for the 1.2.0rc2 candidate.')
    else:
        ...
        for needle in [
            ...
            if needle not in rc_notes:
                errors.append(f'RELEASE_NOTES_v1.2.0-rc2.md missing RC safety evidence: {needle}')
    notes.append('v1.2.0rc2 candidate staging is active while published v1.1.0 citation/Zenodo metadata remains authoritative.')
else:
